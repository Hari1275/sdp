...
export const updateAreaSchema = createAreaSchema.partial().omit({ regionId: true })
...
export type CreateBusinessEntryInput = z.infer<typeof createBusinessEntrySchema>
